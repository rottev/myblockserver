...
<head>
	<meta charset="utf-8">
	<title>DocStrap Source: validation/parameters/string.js</title>
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<h1 class="page-title">Source: validation/parameters/string.js</h1>
...
var validateString = function(param, value) {
  ...
  if (param.pattern &amp;&amp; _.isString(param.pattern)) {
    try {

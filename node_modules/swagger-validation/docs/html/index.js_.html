...
<head>
	<meta charset="utf-8">
	<title>DocStrap Source: validation/paramTypes/index.js</title>
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<h1 class="page-title">Source: validation/paramTypes/index.js</h1>
    
<section>
	<article>
		<pre
			class="sunlight-highlight-javascript linenums">/** @namespace Validation.ParamTypes */
module.exports.body = require('./body');
module.exports.form = require('./form');
module.exports.header = require('./header');
module.exports.path = require('./path');
module.exports.query = require('./query');</pre>
	</article>
</section>
